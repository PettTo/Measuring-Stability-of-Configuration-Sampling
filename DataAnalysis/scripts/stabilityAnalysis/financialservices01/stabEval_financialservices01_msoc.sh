...
FILENAME_CSV=chvatal/chvatal.csv
...
#Execute
java -Xmx9g -jar ./tools/stability_evaluator/StabilityCalculator.jar ${NAME_METRIC} ${PATH_CSV} ${FILENAME_CSV} ${PATH_BASE_MODEL}/${prevFolder} ${PATH_BASE_SAMPLE}/${prevVersion}/${FILENAME_INTERFOLDER}/${FILENAME_SAMPLE_FOLDER}/ ${PATH_BASE_MODEL}/${newFolder} ${PATH_BASE_SAMPLE}/${newVersion}/${FILENAME_INTERFOLDER}/${FILENAME_SAMPLE_FOLDER}/ ${prevFolder} ${newFolder}
...
PATH_BASE_SAMPLE=${PATH_CURRENT}/data/financialServices01/samples/
FILENAME_CSV=incling/incling.csv
...
PATH_BASE_SAMPLE=${PATH_CURRENT}/data/financialServices01/samples/
FILENAME_CSV=random/random.csv
FILENAME_INTERFOLDER=Random
FILENAME_SAMPLE_FOLDER=products_Rand1
###time step 1
prevFolder=model00001.xml
newFolder=model00002.xml
