...
########## Automotive2 ############
CsvData <- read.csv(file="./data/financialServices01/stability_csv/combined.csv",header=TRUE, sep=";",colClasses=c("NULL",NA,NA,NA,NA)) 
...
pdf(file='./data/financialServices01/stability_csv/plots/financialservices01_scatter.pdf', width=9, height=6)
plot(x,y, las=2, ylim=c(0,1.1), main="FinancialServices01 Scatterplot",
     axes=FALSE,
...
pdf(file='./data/financialServices01/stability_csv/plots/financialservices01_scatterZoomed.pdf', width=9, height=6)
plot(x,y, las=2, ylim=c(0.5,1.1), main="FinancialServices01 Scatterplot Zoomed",
     axes=FALSE,
     #par(mar = c(7, 8, 6, 2) + 0.1)#,
     #pch=c(19,19,19,17,17,17)#,
     #col=c(rep(tubsBlue,length(incling)), rep(tubsRed,length(random)))
...
pdf(file='./data/financialServices01/stability_csv/plots/financialservices01_box.pdf', width=9, height=6)
#svg(file='./data/automotive02/stability_csv/plots/automo_algo_stab_no_preservative.svg', width=9, height=6)
boxplot(Data, las = 2, ylim=c(0,1), main="FinancialServices01 Boxplot",
